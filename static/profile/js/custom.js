(function($){
	...
	$(document).ready(function() {
		...
		$('#intro').backstretch(['static/profile/images/bg.jpg']);
		...
		$(window).scroll(function() {
			if($(this).scrollTop() >= navHeight) {
				...
				$('.navbar-brand')[0].innerHTML = "Manak Kapoor";
			}
			else {
				navbar.removeClass('navbar-color');
				$('.navbar-brand')[0].innerHTML = "<img src = 'static/images/mkw.png' style = 'height:inherit'/>";
			}
		});
		...
		$('#portfolio').magnificPopup({
			...
			image: {
				tError: 'No screenshot available',
